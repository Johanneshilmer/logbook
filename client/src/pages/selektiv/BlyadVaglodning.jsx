...
export default function BlyadVaglodning({ socket }) {
  ...
  const parentIdentifier = 'Blyad Våglödning';  // Unique identifier for this parent
  ...
  const toggleButton = 'outline-danger';
  const editButton = 'danger';
